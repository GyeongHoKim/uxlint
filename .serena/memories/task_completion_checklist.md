...
These quality gates are enforced by the project constitution (v1.3.0) and prevent commits with type errors, linting violations, or formatting inconsistencies.
